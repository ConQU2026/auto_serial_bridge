...
export function createDefaultMessage(existingMessages = []) {
  ...
  return {
    ...
    debug_log_mode: "on",
    reliable: false,
    sub_topic: `demo/new_message_${messageIndex}`,
    pub_topic: `demo/new_message_${messageIndex}`,
    ros_msg: "std_msgs/msg/UInt32",
    notes: "",
